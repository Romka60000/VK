...
class OAuthWindow(QObject):
    ...
    def __init__(self, VKAPI):
        ...
        self.__web_view.setUrl(QUrl('https://oauth.vk.com/authorize?client_id=' + VKAPI.app_id +'&display=mobile&redirect_uri=http://vk.com&scope=offline,wall,messages,audio,video,friends&response_type=code&v=5.60'))
        self.__VKAPI = VKAPI
